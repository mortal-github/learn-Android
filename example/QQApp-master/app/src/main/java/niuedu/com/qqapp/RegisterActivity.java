...
import niuedu.com.qqapp.Service.ChatService;
import niuedu.com.qqapp.adapter.ContactsPageListAdapter;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void showTackPhotoView() {
        ...
        this.imageUri = FileProvider.getUriForFile(this,
                "niuedu.com.qqapp.fileprovider", imageOutputFile);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case TAKE_PHOTO:
                ...
                //Uri imageUri = FileProvider.getUriForFile(this,"niuedu.com.qqapp.fileprovider", finalImage);
